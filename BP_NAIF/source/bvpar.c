...
//~ static int numpix[2];
 ...
 #ifdef INPUT_TXT
finp=fopen("/home/pablo/local.git/pablo/FP/input/inputint.txt", "r");
...
sprintf(nombrearchivo, "/home/pablo/local.git/pablo/res/angulo_%d.txt", contador);
...
sprintf(nombrearchivo, "/home/pablo/local.git/pablo/res/rayo%d_%d_%d.txt", contador3, contador, contador2);
