...
////Parallel_beam functions
//#include <stdio.h>
//#include <stdlib.h>
//#include <math.h>
 //#include "../headers/init_coe.h"

//void pa_initialize_coef_flo_2pi( int cont, int NumPix, int NumAng, float factordim,  int limy, int dimx, int dimy, float deltaang, float factorpos, float **coe){
	...
	////~ {
		////~ #pragma omp for private(cont2, cont3, pixx, pixy, cosbeta, sinbeta, beta, deltax, deltay, posx, posy, posx2, posy2)
			...
			////~ {
				...
				//cosbeta=cos(beta);
				//sinbeta=sin(beta);
				//printf("beta = %f, dimx, dimemsiones = %d %d, limy = %d, NumPix %d\n", beta, dimx, dimy, limy, NumPix);
				...
				//{
					...
					//{
						...
						//printf("cont1 %d cont2 %d %d %f \t %d %d %f\n", cont, cont2, pixx*limy+pixy, coe[cont*NumPix+cont2][pixx*limy+pixy], cont*NumPix+cont2, pixx*limy+pixy+1, coe[cont*NumPix+cont2][pixx*limy+pixy+1]);
				...
				//}
				//printf("Están sin inicializar los coe antes de entrar aqui¿?\n");
	...
	//void pa_initialize_coef_flo_abanico( int cont, int NumPix, int NumAng, float factordim, int limy, int dimx, int dimy, float deltaang, float factorpos, float *angulos, float **coe){	
...
void pa_initialize_coef_flo_2pi( int cont, int NumPix, int NumAng, float factordim,  int limy, int dimx, int dimy, int dimtot, int NRay, float deltaang, float factorpos, float *coe){
	...
	void pa_initialize_coef_flo_abanico( int cont, int NumPix, int NumAng, float factordim, int limy, int dimx, int dimy,int dimtot, int NRay, float deltaang, float factorpos, float *angulos, float *coe){	
